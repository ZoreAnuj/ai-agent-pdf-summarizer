import { BrainCircuitIcon, FileOutput, FileText } from "lucide-react";
...
const steps: Step[] = [
  {
    ...
    description:
      "Drag and drop your PDF file into the upload area or click to select a file from your device. We support various PDF formats.",
  },
  {
    icon: <BrainCircuitIcon size={64} strokeWidth={1.5} />,
    label: "AI Processing",
    description:
      "Our AI algorithms analyze the content of your PDF, extracting key points and summarizing the information.",
  },
  {
    icon: <FileOutput size={64} strokeWidth={1.5} />,
    label: "Get Summary",
    description:
      "Receive a concise summary of your PDF, highlighting the most important information. You can download or share it easily.",
  },
];
